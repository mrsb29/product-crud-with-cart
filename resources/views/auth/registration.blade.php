...
<head>
    <title>Registration Page || Admin Panel</title>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" action="/register" method="POST" >
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Registration page</h3>
                                    </div>
                                </div>
                                <div class="row m-b-20">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group form-primary">
                                    <input type="email" class="form-control" id="email" name="email"  required autofocus autocomplete="name" >
                                    <span class="form-bar"></span>
                                ...
                                <p class="text-inverse text-left">Just login with that credentials which seed in database <a
                                        href="auth-sign-up-social.html"></a></p>
                            </div>
                        </div>
                    </form>
